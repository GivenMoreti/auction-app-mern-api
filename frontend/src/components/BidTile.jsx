    ...
    <div className="p-4">
      <div className="flex flex-col md:flex-row shadow-lg rounded-2xl overflow-hidden bg-white hover:shadow-xl transition-shadow duration-300">
        ...
        <div className="md:w-2/3 p-4 flex flex-col justify-between">
          <div>
            <h2 className="text-2xl font-bold text-blue-800 mb-2">{item.auction.item.title}</h2>
          ...
          <CustomBtn title={"Go to Auction"} className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors duration-300"/>
        </div>
      </div>
    </div>
  );
